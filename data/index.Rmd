...
My story covers the difference between Arkansas’ increase in electric vehicles as a percentage point against the entirety of the nation. The Natural State is lagging at about half the year-to-year increase percentage-wise in comparison to the national average on light-duty electric vehicles – only being better than Mississippi in a border-state comparison. 

This story is timely due to the cuts of federal programs supporting charging station development, Elon Musk’s return to Tesla following a shaky Q1 earnings call, and the national rescinding of climate-conservation standards.

My target audience for this story includes environmental conservationists, automotive industry enthusiasts, and electric vehicle enthusiasts. 
...
The impact of this story not being reported is that we, as taxpayers, have paid into the building of electric vehicle charges but do not have the same driver infrastructure ratio as our neighboring states (excluding Mississippi). However, the drivers pay a $200, $100, or $50 “lost gas” tax that goes back into road infrastructure and other similar programs – so we can ask ARDOT if the lack thereof usage of the road solely hurts non-EV drivers. Once I hear back from Scott Hardin, I will know what percentage of the total revenue it makes up. However, it still leaves many questions regarding how “worth it” it was for the state to fund the amount of charging stations.

Additionally, for environmental conservationists, there are an assortment of problems with other rural states, such as Alabama and Tennessee, staying ahead of us in the EV percentage increase. Northwest Arkansas has continued to grow as a technological point in the South but lacks this specific statistic. Why is it that Alabama is better than us? Are they putting even MORE charging stations or just having better locations? 

The visuals for this story will include an assortment of EVs charging across the state. Showing a charger in Jonesboro, Texarkana, and Fayetteville will emphasize how much was invested in the charging programs. Also, a graphic showing the percentage climb of the nation, Arkansas, and similar states will provide better context for readers.

There are a lot more steps to include in this. Including the year-to-year gas revenue totals will be essential to telling the story of how much money the state makes from EV owners to fund our state’s road infrastructure. Another unique element is comparing the national amount of electric vehicle charging stations per person in comparison to how much the state is driving. 

Also, I want to pull more statistics of Arkansas’ totals for different hybrid types. 

If I am unable to get the extra data mentioned, a realistic date for this is within a week and a half. The interviews will be scheduled over Zoom for the next week.

MY DATA/MATH
Percentage of total vehicles that are EV (EV, hybrid and plug-in hybrid)
